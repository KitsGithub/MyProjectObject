...
var app = new Vue({
	...
	　　　　//判断滚动到底部
        ...
        ajaxgoods: function (event) {
        	var that = this;
        	var requestURL = appURL+"/CarsBooking/GetCarsOrderDetailsH";
          ...
          $.ajax({
		        ...
		        success: function (data) {
		        	...
		        	if(data.Code==0){
		        		...
		        		data.Data.booked_by.forEach(function(val,index){
		        			that.arrs.push(val);			    
		        		});

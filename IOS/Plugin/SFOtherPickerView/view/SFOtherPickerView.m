...
- (void)setResourceArray:(NSArray<NSString *> *)resourceArray {
    ...
    if (w == 320) {
        buttonViewHieght = ceilf(_resourceArray.count / 3.0) * (36 + 14);
    } else {
        buttonViewHieght = ceilf(_resourceArray.count / 4.0) * (36 + 14);
    }
...
- (void)layoutSubviews {
    if (hasSubView) {
        ...
        CGFloat buttonViewHieght = self.contentHeight - 50 - 62;
